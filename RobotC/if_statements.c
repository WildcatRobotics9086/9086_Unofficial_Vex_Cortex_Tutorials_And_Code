...
if (variable1 == 1) { //runs when variable1 is equal to 1
  //your code here
}
if (variable1 <= 1) { // * runs when variable1 is less than or equal to 1
  //your code here
}
if (variable1 < 1) { // * runs when variable1 is less than 1
  //your code here
}
if (variable1 >= 1) { // * runs when variable1 is greater than or equal to 1
  //your code here
}
if (variable1 > 1) { // * runs when variable1 is greater than 1
  //your code here
}
if (variable1 != 1) { // * runs when variable1 is not equal to 1
  //your code here
}
if ((variable1 == 1) && (variable2 == 2)) { //runs when variable1 is equal to 1 and variable2 is 2
  //your code here
}
...
else { //runs when the previous condition is not met
  //more code here
}
